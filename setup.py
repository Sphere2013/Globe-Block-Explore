...
setup(
    ...
    url          = "https://github.com/globe-abe/globe-abe",
    classifiers=[
    ...
    description  = "Abe: a free block chain browser for Globe-based currencies.",
    long_description = """Abe reads the Globe block chain from disk, loads
it into a database, indexes it, and provides a web interface to search
and navigate it.  Abe works with several Globe-derived currencies,
including Namecoin and LiteCoin.

Abe draws inspiration from Globe Block Explorer (BBE,
