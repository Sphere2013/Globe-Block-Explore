...
def parse_setting(setting, vds):
  if setting[0] == "f":  # flag (boolean) settings
    ...
    return "" # globe 0.4 purposely breaks addrIncoming setting in encrypted wallets.
...
# As of 8/2011, the Original Globe Client does not use it.  CAuxPow
...
def extract_public_key(bytes, version='\x00'):
  ...
  # Pay-by-Globe-address TxOuts look like:
