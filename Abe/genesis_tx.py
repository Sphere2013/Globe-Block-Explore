...
# historical reasons: https://globetalk.org/index.php?topic=119530.0
...
def get(tx_hash_hex):
    ...
    by, e.g., "globed getblock 0") return the hexadecimal raw
    transaction.  This works around a Globed limitation described at
    https://globetalk.org/index.php?topic=119530.0
    """
