...
# This function comes from globetools, bct-LICENSE.txt.
def determine_db_dir():
    import os
    import os.path
    import platform
    if platform.system() == "Darwin":
        return os.path.expanduser("~/Library/Application Support/Globe/")
    elif platform.system() == "Windows":
        return os.path.join(os.environ['APPDATA'], "Globe")
    return os.path.expanduser("~/.globe")
...
def target_to_work(target):
    # XXX will this round using the same rules as C++ Globe?
