...
ABE_URL = 'https://github.com/globe-abe/globe-abe'

COPYRIGHT_YEARS = '2011'
COPYRIGHT = "Abe developers"
COPYRIGHT_URL = 'https://github.com/globe-abe'

DONATIONS_GLB = '1PWC7PNHL1SgvZaN7xEtygenKjWobWsCuf'
...
<body>
    ...
    <p style="font-size: smaller">
        ...
        %(download)s
        Tips appreciated!
        <a href="%(dotdot)saddress/%(DONATIONS_GLB)s">GLB</a>
...
class Abe:
    ...
    def handle_chains(abe, page):
        ...
        body += [
            ...
            '% <a href="https://en.globe.it/wiki/Globe_Days_Destroyed">',
            'CoinDD</a></th>',
            '</tr>\n']
    ...
    def get_default_chain(abe):
        return abe.chain_lookup_by_name('Globe')
        ...
        for t in types:
            def process(row):
                if   t == 'tx':    name = 'Transaction'
                    ...
                    # XXX Use Globe address version until we implement
    ...
    def q_hashtoaddress(abe, page, chain):
        ...
        if arg2 is not None:
            ...
            # Default: Globe address starting with "1".
    ...
    def q_hashpubkey(abe, page, chain):
        ...
        if pubkey is None:
            return \
                ...
                "For example, the Globe genesis block's output public key," \
