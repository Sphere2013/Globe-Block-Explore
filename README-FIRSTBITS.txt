...
another site when sending globes.  See this forum thread, and note
that Abe does not currently implement the algorithm proposed there:
https://globetalk.org/index.php?topic=16217.msg960077#msg960077
...
(https://globetalk.org/index.php?topic=22785.msg949105#msg949105) or
...
Note that address_version for Globe addresses is always "\0" (or
"00" in hex).  The field exists because Abe supports multiple
currencies with different address versions, such as Globe Testnet
and Namecoin.
...
(for Globe, or the desired chain_id from the chain table).
...
An alternative table-based approach is libglobe's span_left and
