...
# globetools -- modified deserialize.py to return raw transaction
import Abe.deserialize
import Abe.util  # Added functions.
import Abe.base58
from Abe.abe import *

AML_APPNAME = "Globe ecdsa.org"
...
<body>
  <div id="logo">
   <a href="%(dotdot)s/">
    <img src="http://s3.ecdsa.org/bc_logo.png" alt="Globe logo" border="none" />
   </a> 
  </div>
  <div id="navigation">
    <ul>
...
This site is powered by <span style="font-style: italic"> <a href="https://github.com/globe-abe/globe-abe">globe-ABE</a></span>
&nbsp;&nbsp;source:<a href="ecdsa.py">[1]</a>&nbsp;<a href="abe.diff">[2]</a>
    ...
    def handle_qr(abe,page):
        ...
        ret = """<html><body>
               ...
               <div id="qrcode"></div>
               <script>jQuery('#qrcode').qrcode("globe:%s");</script>  
               </body></html>"""%address
    ...
    def handle_address(abe, page):
        ...
        body += [ '<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.5.2/jquery.min.js"></script>',
                  ...
                  "<script>jQuery('#qrcode').qrcode(\"globe:"+address+"\");</script>"  ]
    ...
    def handle_annotate(abe, page):
        ...
        if not tx_hash and not address:
            ...
            page['body'] += [ 'This website allows you to annotate the Globe blockchain.<br/><br/>',
                              'You will need a version of globed that has the "signmessage" command.<br/>'
        ...
        if tx_hash:
            ...
            if message or signature:
                ...
                # check signature
                import globerpc
                conn = globerpc.connect_to_local()
            ...
            """
                ...
                page['body'] = [
                    ...
                    '<pre>globed signmessage <span id="saddress">'+in_addresses[0]+'</span> "'+tx_hash+':<span id="stext">your text</span>"</pre>\n'
        ...
        if address:
            ...
            """
                ...
                page['body'] = [
                    ...
                    'The signature will be returned by the following command line:<br/>\n'
                    '<pre>globed signmessage <span id="saddress">'+address+'</span> "<span id="stext">your text</span>"</pre>\n'
                    'Signature:<br/><input name="signature" value="" style="width:500px;"/><br/>'
    ...
    def handle_thresholdRelease(abe, page):
        ...
        if address:
            ...
            """
            msg= """
This service allows you to release digital content when a requested amount of Globe donations has been reached.<br/>
<br/>
...
"""
            ...
            page['body'] = [
                ...
                'You must provide a signature in order to demonstrate that you own the globe address of the fundraiser.<br/>'
                'The signature will be returned by the following command line:<br/>\n'
                '<pre>globed signmessage <span id="saddress"></span> <span id="stext">fundraiser</span></pre>\n'
                'Signature:<br/><input name="signature" value="" style="width:500px;"/><br/>'
                '<button type="submit">Submit</button>\n'
                '</form>\n'
                ]
    ...
    def handle_widgets(abe, page):
        ...
        if target:
            ...
            title = "%d"%percent + " percent of %.2f GLB"%target
        else:
            title = ""
            progress = leftwidth
        ...
        text = "Donate"
        link_text  = "<a style=\"text-decoration:none;color:"+textcolor+"\" href=\"javascript:alert('Donate to this Globe address:\\n"+address+"');\">"+text+"</a>"
